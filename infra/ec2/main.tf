...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i /home/ubuntu/keys/jenkins-terraform-aws-project-1 ubuntu@", aws_instance.dev_proj_1_ec2.public_ip)
}
...
resource "aws_instance" "dev_proj_1_ec2" {
  ...
  key_name                    = "jenkins-terraform-aws-project-1"
